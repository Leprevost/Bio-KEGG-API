...
Examples:
	...
	$api->database_info(database => 'kegg');
	$api->database_info(database => 'pathway');
	$api->database_info(database => 'hsa');
...
Examples:
	...
	$k->entry_list(database => 'pathway');
	$k->entry_list(database => 'pathway', organism => 'hsa');
	$k->entry_list(organism => 'hsa');
...
Example:
	...
	$k->data_search(database => 'reaction', query => 'kinase');
	$k->data_search(database => 'reaction', query => 'kinase');
	$k->data_search(database => 'reaction', organism => 'hsa', query => 'kinase');
